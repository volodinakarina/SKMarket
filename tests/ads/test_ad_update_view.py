...
class TestAdUpdateView:
    ...
    def test_ad_update_view_by_owner(self, client, ad, user_and_access_token):
    ...
    @pytest.mark.django_db
    def test_ad_update_view_by_admin(self, client, ad, admin_access_token):
        data = {
            'title': 'test title',
            'price': 1,
            'description': 'test description',
    ...
    @pytest.mark.django_db
    def test_update_ad_errors(self, ad, client, user_and_access_token, access_token_2):
        user, access_token = user_and_access_token
        ad.author = user
        ad.save()
        data = {
